   ...
   <div className="flex flex-col bg-white max-w-[520px] p-1 sm:p-5 rounded-md shadow-md border bg-card"  ref={elementRef} >
    {/* HEAD  */}
            ...
            <div className="mt-3 py-2 px-2 sm:px-5 w-full flex h-[100px] relative">
               <Image src={`https://ghchart.rshah.org/taqui-786`} alt="Contrbuition Graph" fill={true} loading="eager" priority />
          </div>
          <span className="w-full text-center mt-2 text-xs">Get your&#39;s at gitest.vercel.app </span>
          </div>
